...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	authenticationService := service.NewAuthenticationService(context, userRepo, userCredentialRepo, roleRepo, tenantRepo, membershipRepo, orgUnitRepo, permissionRepo, authenticator, clientType, captcha, loginRateLimiter)
	...
	taskService := service.NewTaskService(context, taskRepo, userRepo, backupRepo, minIOClient)
